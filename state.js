...
Q8.State = (function () {
  ...
  function loadNotifications() {
    try {
      ...
      if (settings)
        _state.notificationSettings = { ..._state.notificationSettings, ...JSON.parse(settings) };
    } catch (e) {
  ...
  function saveDefaultDuration() {
    try {
      localStorage.setItem('q8_default_duration', String(_state.defaultDurationMinutes));
    } catch (e) {}
  }
