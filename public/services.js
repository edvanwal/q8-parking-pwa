...
Q8.Services = (function() {
    ...
    function tryOpenOverlay(id, contextData = null) {
        const allowedSwitches = ['menu-overlay', 'sheet-plate-selector', 'sheet-zone', 'sheet-facilities', 'modal-add-plate', 'modal-edit-plate', 'modal-forgot-password', 'modal-confirm-delete-plate', 'modal-confirm-daypass', 'modal-confirm-start'];
